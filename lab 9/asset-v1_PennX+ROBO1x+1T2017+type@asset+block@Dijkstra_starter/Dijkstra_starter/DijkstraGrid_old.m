function [route,numExpanded] = DijkstraGrid_old(input_map, start_coords, dest_coords, drawMap)
...
while true
   ...
   % ********************************************************************* 
    ...
    [current, index] = min(C(C>=0));
    
    current = -current + dest_node;
  % start_node = current;
